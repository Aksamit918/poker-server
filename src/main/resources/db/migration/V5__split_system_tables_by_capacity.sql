UPDATE game_tables SET max_players = 10, name = 'Последний додеп · Live 10-max'
WHERE is_system = TRUE AND small_blind = 10 AND big_blind = 20 AND name = 'Последний додеп';

UPDATE game_tables SET max_players = 9, name = 'Отчаяние · Full Ring'
WHERE is_system = TRUE AND small_blind = 10 AND big_blind = 20 AND name = 'Отчаяние';

UPDATE game_tables SET max_players = 6, name = 'Безысходность · 6-max'
...
INSERT INTO game_tables (
    ...
    gen_random_uuid(), 'На два фронта · Heads-Up', 10, 20, 2, 2, FALSE, TRUE, NOW(), 200, 2000
);

UPDATE game_tables SET max_players = 10, name = 'Для гоев · Live 10-max'
WHERE is_system = TRUE AND small_blind = 100 AND big_blind = 200 AND name = 'Для гоев';

UPDATE game_tables SET max_players = 9, name = 'Not bad, not bad · Full Ring'
WHERE is_system = TRUE AND small_blind = 100 AND big_blind = 200 AND name = 'Not bad, not bad';

UPDATE game_tables SET max_players = 10, name = 'Лудоприключение · Live 10-max'
WHERE is_system = TRUE AND small_blind = 1000 AND big_blind = 2000 AND name = 'Лудоприключение';

UPDATE game_tables SET max_players = 10, name = 'Хамам · Live 10-max'
WHERE is_system = TRUE AND small_blind = 100000 AND big_blind = 200000 AND name = 'Хамам';

UPDATE game_tables SET max_players = 9, name = 'Турецкая баня · Full Ring'
WHERE is_system = TRUE AND small_blind = 100000 AND big_blind = 200000 AND name = 'Турецкая баня';

UPDATE game_tables SET max_players = 6, name = 'Римская баня · 6-max'
WHERE is_system = TRUE AND small_blind = 100000 AND big_blind = 200000 AND name = 'Римская баня';

UPDATE game_tables SET max_players = 2, name = 'Финская баня · Heads-Up'
WHERE is_system = TRUE AND small_blind = 100000 AND big_blind = 200000 AND name = 'Финская баня';

UPDATE game_tables SET max_players = 10, name = 'Лудоприключение VIP · Live 10-max'
